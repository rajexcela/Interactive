...
from HelpFunctions import create_dataset, init_centroids, Kmeans_EStep, Kmeans_MStep, make_kmeans_viz_data
...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        ], style = {'height' : '14%', 'border-radius':10, 'borderStyle' : 'solid', 'borderWidth' : 2, 'borderColor' : 'black', 'background-color':'white'}
        ),
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        dcc.Slider(id='sample-slider', min=50, max=500, step=50, value=200, marks={50:'50', 500:'500'})
                ...
                html.Div([
                    html.H6('INITIALIZE K-MEANS', style = {'text-align':'center', 'marginBottom':15, 'fontSize':15, 'fontWeight':800, 'color' : '#4B4D55'}),
                    ...
                    html.Div([
                            ...
                            dcc.Slider(id='iter-slider', min=5, max=20, step=1, value=10, marks={5:'5', 20:'20'})
                        ], style = {'marginLeft': 10, 'marginRight': 10, 'marginBottom':15}),  
            ...
            ], className='three columns', style = {'background-color':'white', 'height' : '100%', 'borderStyle' : 'solid', 'border-radius':10, 'borderWidth' : 2, 'borderColor' : 'black'}),
            
            # ROW 2 - SECOND PART (K-MEANS SCATTERPLOT)
            html.Div([
                html.H6('K-MEANS SCATTER PLOT', style = {'text-align':'center', 'marginTop' : 30, 'marginBottom':5, 'fontSize':15, 'fontWeight':800, 'color' : '#4B4D55'}),

                html.Button('Play', id='play-button', style={'marginLeft':45, 'marginTop':30, 'marginBottom':10, 'marginRight':5, 'width':'5%', 'font-size':10, 'text-align': 'center', 'padding': 0}),
                html.Button('Pause', id='pause-button', style={'marginRight':5, 'width':'8%', 'font-size':10, 'text-align':'center', 'padding': 0}),
                html.Button('<<', id='prevStep-button', style={'marginRight':5, 'width':'5%', 'font-size':10, 'text-align':'center', 'padding': 0}),
                html.Button('>>', id='nextStep-button', style={'marginRight':5, 'width':'5%', 'font-size':10, 'text-align':'center', 'padding': 0}),
                html.Button('Restart', id='restart-button', style={'width':'10%', 'font-size':10, 'text-align':'center', 'padding': 0}),

                html.Button(id='iter-text', disabled=True, style={'marginLeft':'14.5%', 'width':'22%', 'background-color':'#4B4D55', 'pointer-events': 'none', 'color':'white', 'font-size':10, 'text-align':'center', 'padding': 0}),
                ...
                html.Div([
                    html.Img(src=app.get_asset_url('Signature_Logo.png'), style={'height':'100%', 'float':'right'})
                    ], style={'height':'10%', 'top':'0%', 'position':'relative'})

            ], className = 'nine columns', style = {'background-color':'white', 'height' : '100%', 'border-width':2, 'borderStyle' : 'solid', 'border-radius':10, 'borderColor' : 'black'}),
 
        ], style = {'height' : '84%', 'position':'relative', 'top':'2%'}) 
    ], className = 'eight columns', style = {'height':'96%'}),
...
def update_inertia_graph(frames_counter):
    ...
    data2 = go.Scatter(
        ...
        mode = 'text',
        text = 'Global Minimum',
        name = str(round(globalInertia[1])),
        hoverinfo = 'name',
        textfont = dict(
            color = "white"
        )
